...
<label for="my-modal-3" class="btn modal-button bg-white text-black hover:bg-[#F2F2F2]">Add new</label>
  ...
  <div class="modal-box relative">
    ...
    <div className='flex justify-center items-center w-full'>
            ...
            <div class="form-control w-full max-w-xs">
                    ...
                    <input type="text" name='subject'  class="input input-bordered w-full max-w-xs" />
            </div>
            <div class="form-control w-full max-w-xs">
                    <label class="label">
